...
import { Columns3, Download, ListFilter, Plus, Search, Upload, Zap, Eye, Pencil, Send, User, Link, Trash2, Phone } from "lucide-react";
...
const Page = () => {
  ...
  const columns: TableColumn<LeadData>[] = [
    ...
    { key: "moderationFeedback", label: "Moderation Feedback", sortable: true, render: (value) => <span className="italic text-body">{value}</span> },
    { key: "lastFeedback", label: "Last Feedback", sortable: true, render: (value) => <span className="italic text-body">{value}</span> },
    {
      key: "communicated",
      label: "Communicated",
      sortable: true,
  ...
  return (
    <div className="mt-7">
      ...
      <div className="mt-7 bg-white flex items-center rounded py-3 px-4 justify-between">
        <div className="flex items-center gap-2">
           <p className="text-mainText italic text-base font-bold flex items-center gap-2  p-3 bg-background/5 rounded">
            All Leads{" "}
            <span className="text-white bg-primary p-1 rounded-full">1000</span>
          </p>
        ...
        <div className="flex items-center gap-2">
          ...
          <button className="flex items-center gap-2 px-4 py-3 border bg-primary rounded-lg border-primary">
            ...
            <span className="text-white text-sm font-bold ">Add new lead</span>
          </button>
        </div>
      </div>
      <div className="flex mt-5 max-w-[50%] items-center gap-3">
        ...
        <button className="flex items-center text-white rounded-3xl bg-[#8CE553] py-2 px-5  gap-2 bg">

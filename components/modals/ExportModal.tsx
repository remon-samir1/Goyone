...
import { getStatuses, exportLeads } from "@/lib/api";
...
const ExportModal: React.FC<ExportModalProps> = ({ isOpen, onClose }) => {
  ...
  const handleExport = async () => {
    setIsExporting(true);
    try {
      const exportParams = exportScope === "all" ? {} : filters;
      const response = await exportLeads(exportParams);
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          "relative bg-white dark:bg-gray-800 rounded-3xl w-full max-w-[600px] shadow-2xl transform transition-all duration-300 ease-out max-h-[90vh] overflow-y-auto",
      ...
      >
        <div className="p-8">
          ...
          <div className="space-y-6">
            ...
            <div>
              <h3 className="text-sm font-bold text-mainText italic mb-3">
                Export scope
              </h3>
              <div className="space-y-3">
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-sm text-body italic">
                      Export all leads in your database
                    </p>
                  </div>
                </div>
                ...
                {exportScope === "filtered" && (
                  <div className="bg-[#F8FAFC] rounded-xl p-5 border border-stroke space-y-4 animate-in fade-in slide-in-from-top-2 duration-300">
                    ...
                    <div>
                      <h5 className="text-sm font-bold text-mainText italic mb-2">
                        Date range
                      </h5>
                    ...
                    <div>
                      ...
                      <div className="relative">
                        <select
                          ...
                          className="w-full bg-white border border-stroke rounded-lg py-2 pl-3 pr-10 appearance-none focus:outline-none focus:border-primary text-sm text-body italic cursor-pointer"
                        >
            ...
            <div className="flex items-center justify-end gap-3 pt-2">
              ...
              <button
                ...
                className="px-8 py-2.5 rounded-full bg-primary text-white text-sm font-bold italic hover:bg-primary/90 transition-colors shadow-lg shadow-primary/30 disabled:opacity-50 flex items-center gap-2"
              >

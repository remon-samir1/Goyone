...
const ConvertLeadModal = ({
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          "relative bg-white dark:bg-gray-800 rounded-3xl w-full max-w-[600px] shadow-2xl transform transition-all duration-300 ease-out flex flex-col overflow-hidden",
